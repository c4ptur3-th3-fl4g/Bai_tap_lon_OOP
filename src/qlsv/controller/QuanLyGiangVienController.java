...
public class QuanLyGiangVienController {
    ...
    private GiangVienSercive giangVienSercive = null;
    ...
    public QuanLyGiangVienController(JPanel jpnView, JButton btnAdd, JButton btnDelete, JTextField jtfSearch) {
        ...
        this.giangVienSercive = new GiangVienServiceImpl();
    }

    public void setDateToTable() {
        List<GiangVien> listItem = giangVienSercive.getList();
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    sinhVien.setMa_giang_vien((int) model.getValueAt(selectedRowIndex, 1));
                    ...
                    sinhVien.setTinh_trang(model.getValueAt(selectedRowIndex, 7).toString().equalsIgnoreCase("Vẫn còn dạy"));
